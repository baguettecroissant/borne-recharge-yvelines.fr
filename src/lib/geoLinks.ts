/**
 * Geographic proximity linking engine for Yvelines (78).
...
export function getNearbyCommunes(
  ...
  return allCommunes
    ...
    .map(c => {
      ...
      // Approximate physical distance in km using local projection (48.80°N for Yvelines)
      // 1 degree of Latitude ≈ 111.1 km
      // 1 degree of Longitude ≈ 111.1 * cos(48.80°) ≈ 73.1 km
      const dLat = (lat - currentLat) * 111.1;
      const dLon = (lon - currentLon) * 73.1;
