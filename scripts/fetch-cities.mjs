...
async function fetchCities() {
  const url = 'https://geo.api.gouv.fr/departements/78/communes?fields=nom,code,population,codesPostaux,centre';
  
  console.log('Fetching Yvelines (78) communes from Geo API...');
  try {
    ...
    // Process and filter communes in Yvelines (78) with population >= 2000
    const processed = data
      .map(c => {
        let lat = 48.801408; // Versailles lat
        let lng = 2.130122;  // Versailles lng
